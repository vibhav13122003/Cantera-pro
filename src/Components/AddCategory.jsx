        ...
        <div className='mb-4'>
          ...
          <div className='relative'>
            <input
              ...
              className='w-full border border-gray-300 rounded-lg pl-5 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600'
              value={country.name}
